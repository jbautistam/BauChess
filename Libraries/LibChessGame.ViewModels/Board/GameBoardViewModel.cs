...
namespace Bau.Libraries.LibChessGame.ViewModels.Board
{
	/// <summary>
	...
	public class GameBoardViewModel : Mvvm.BaseObservableObject
	{
		...
		// Variables privadas
		private Scapes.ScapesBoardViewModel _scapes;
		...
		/// </summary>
		private bool CanExitVariation()
		{
			return IsAtVariation;
		}
		...
		/// </summary>
		private MovementVariationModel VariationGame { get; set; }

		/// <summary>
		///		Lista de movimientos de la variación actual (con la que se hacen los movimientos)
		/// </summary>
		private MovementVariationModel ActualVariationGame { get; set; }
