...
namespace Bau.Libraries.LibPgnReader.Parsers
{
	...
	/// </summary>
	internal class SentencesParser : IDisposable
	{
		/// <summary>
		///		Abre un archivo
		/// </summary>
		...
		{
			using (IEnumerator<TokenModel> tokenEnumerator = Reader.Read().GetEnumerator())
			{
		...
		///		Lector de tokens
		/// </summary>
		private TokenParser Reader { get; set; }
